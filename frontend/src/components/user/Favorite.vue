<template>
  <div @click="checkFavorited">
    <v-icon color="primary" size="30" v-if="isFavorited">mdi-heart</v-icon>
    <v-icon color="pink" size="30" v-if="!isFavorited">mdi-heart-outline</v-icon>
  </div>
</template>
